...
import { MdEmail, MdMessage, MdCreate, MdVisibility } from "react-icons/md";
...
<div className="relative min-h-screen w-full font-inter overflow-hidden">
        {/* Anonimity Logo - top-right, now as image with yellow overlay */}
        <motion.div
        ...
        >
          <div className="relative w-[320px] h-[120px]">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-yellow-400 opacity-40 mix-blend-multiply pointer-events-none rounded-lg" />
          </div>
        </motion.div>
    
        {/* Top-left: Write Gossips */}
        <motion.div
        ...
        >
          <h1 className="text-white text-[clamp(1.5rem,4vw,4rem)] font-normal font-poppins leading-none">
          ...
          >
            <MdCreate className="text-white text-3xl md:text-5xl drop-shadow-[0_0_16px_#fffde4]" />
          </motion.div>
        </motion.div>
    
        {/* Bottom-right: Read Gossips */}
        <motion.div
          className="absolute bottom-24 right-10 z-10 text-right"
          initial={{ opacity: 0, x: 60 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8, delay: 0.4, ease: 'easeOut' }}
        >
          ...
          >
            <MdVisibility className="text-white text-3xl md:text-5xl drop-shadow-[0_0_16px_#fffde4]" />
          </motion.div>
        </motion.div>
    
        {/* Centered two-line text with icon */}
        <motion.div
          ...
          transition={{ duration: 0.8, delay: 0.6, ease: 'easeOut' }}
        >
          <span className="block text-4xl md:text-6xl lg:text-7xl font-normal font-poppins text-white group">
          ...
          <span className="block text-4xl md:text-6xl lg:text-7xl font-normal font-poppins text-white">
          ...
          >
            <MdMessage className="text-white text-4xl md:text-6xl drop-shadow-[0_0_16px_#fffde4]" />
          </motion.div>
        </motion.div>
      </div>
